...
?>
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input type="text" class="eqLogicAttr form-control" data-l1key="configuration" data-l2key="domain" placeholder="{{IP}}"/>
		</div>
     </div>
	 <div class="form-group">
...
<!--	 // <div class="form-group">
		...
		// <div class="col-sm-3">
			// <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
			// <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Port}}"/>
		// </div>
     // </div>
	// <div class="form-group">
		// <div class="col-sm-3">
			// <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
			// <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{IP}}"/>
		// </div>
     // </div>
	// <div class="form-group">
		// <label class="col-sm-3 control-label">{{Domain}}</label>
...
<?php include_file('desktop', 'template', 'js', 'plex');?>
<?php // include_file('desktop', 'slick', 'js', 'plex');?>
<?php include_file('desktop', 'slick', 'css', 'plex');?>
